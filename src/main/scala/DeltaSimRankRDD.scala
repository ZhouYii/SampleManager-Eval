...
object DeltaSimRankRDD {
  ...
  def identityMatrix(sc:SparkContext, numCols:Int) : RDD[(Long, Double)] = {
  ...
  def compute(sc:SparkContext, g:Graph[Int,Int], numIterations:Int) : Array[Double] = {
    ...
    val s0 = identityMatrix(sc, numNodes);
